...
export default function Header() {
  return (
    <header className="shadow-md head fixed w-[70%] top-6 rounded-xl inset-shadow-black backdrop-blur-md flex justify-around items-center px-5 py-3 max-md:w-[95%]  max-md:top-0 max-md:rounded-b-2xl max-md:rounded-t-none z-20">
